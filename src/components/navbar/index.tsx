...
//             <img
//               src="/public/assets/logos/fenix-new.svg"
//               alt="Logo"
...
const Navbar: React.FC = () => {
  return (
    <div className="bg-violet-primary p-[10px] px-4 w-full flex flex-col h-18 relative z-20 items-center">
      <div className="w-full grid grid-rows-1 grid-col-3 place-items-center lg:max-w-[52.5rem]">
        <div className="flex w-full justify-between col-start-1 col-end-4 row-start-1 row-end-2"></div>
      </div>
      <div className="flex col-start-2 col-end-3 row-start-1 row-end-2">
        <img
